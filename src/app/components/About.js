        ...
        <div className="flex flex-col xl:flex-row xl:justify-between">
          ...
          <div className="flex-1 flex items-center xl:justify-center">
            <div className="xl:max-w-[517px]">
              ...
              >
                Rent,schoose , and repair with ease. Our convenient locations,
                diverse car types, and reloable repair points ensure a seamless
                car experience.
              </motion.p>
              {/* stats */}
              <motion.div
                ...
                className="flex items-center justify-center gap-x-8 mb-12"
              >
                {/* car types */}
